...
// Code Here
let doubled = myNumbers.map(function(num){return 2 * num})
//////////////////PROBLEM 15////////////////////

// Now lets use .filter to only get the nubmer(s) greater than 100. Call the new array 'filtered'

// Code Here
let filtered = myNumbers.filter(function(num) {return num > 100})
//////////////////PROBLEM 16////////////////////

// Next up, reduce to get the total of the array. call the new array 'total'

// Code Here
let total = myNumbers.reduce(function(runTot, num) {return runTot + num})
//////////////////PROBLEM 17////////////////////
...
myNumbers.forEach(function(ele, ind) {myNumbersIndex.push(ind)})
//////////////////PROBLEM 18////////////////////
...
forTheLoveOfGeorge = notGeorge.map(function(str) {return 'George'})
//////////////////PROBLEM 19////////////////////
...
// Code Here
let enemies = people.filter(function(obj) {return (!obj.friend)})
//////////////////PROBLEM 20////////////////////
...
// Code Here
let totallyAwesome = people.map(function(ele){return ele.awesomeLevel}).reduce(function(runTot,num) {return runTot + num})